...
ENV_FIELDS = (
    ...
    EnvField("UI_COLOR_IDLE", "#d8dee6", str, "Overlay", "Idle Ring Color", "Ring accent color while Maya is idle. Accepts hex like #d8dee6."),
    EnvField("UI_COLOR_READY", "#62ff8f", str, "Overlay", "Ready Ring Color", "Ring accent color while Maya is ready. Accepts hex like #62ff8f."),
    EnvField("UI_COLOR_HEARING", "#ffd75e", str, "Overlay", "Hearing Ring Color", "Ring accent color while Maya is listening. Accepts hex like #ffd75e."),
    EnvField("UI_COLOR_SPEAKING", "#9ed0ff", str, "Overlay", "Speaking Ring Color", "Ring accent color while Maya is speaking. Accepts hex like #9ed0ff."),
    EnvField("UI_COLOR_ERROR", "#ff6b6b", str, "Overlay", "Error Ring Color", "Ring accent color when Maya hits an error. Accepts hex like #ff6b6b."),
    EnvField("UI_COLOR_CORE", "#ffffff", str, "Overlay", "Core Ring Color", "Main inner ring color. Accepts hex like #ffffff."),
